...
## plot3.R
##
## Course assignment 1.3 for Exploratory Data Analysis (exdata-013) - April 2015
##
## This script takes raw data from one file, "household_power_consumption.txt" and
## produces an output graph stored in "plot3.png"
##
...
## Outputs
##  plot3.png                                       - output plot matching example
...
## Fourth step is to create the desired plot
png("plot3.png")
...
legend("topright", tlines, lty = c(1,1,1), col = c("black", "red", "blue"))
